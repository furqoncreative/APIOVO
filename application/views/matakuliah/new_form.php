			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('matakuliah/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('matakuliah/add') ?>" method="post" enctype="multipart/form-data" >

							<div class="form-group">
								<label for="name">Kode*</label>
								<input class="form-control <?php echo form_error('matakuliah_kode') ? 'is-invalid':'' ?>"
								 type="text" name="matakuliah_kode" placeholder="Kode" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('matakuliah_deskripsi') ? 'is-invalid':'' ?>"
								 type="text" name="matakuliah_deskripsi" placeholder="Deskripsi" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('sks') ? 'is-invalid':'' ?>"
								 type="number" min="0" max="4" name="sks" placeholder="SKS"/>
								<div class="invalid-feedback">
